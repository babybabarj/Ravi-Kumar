...
echo ""
echo "[1/3] Running automated Phase 1B.0 + regression test suite..."
...
echo ""
echo "[3/3] Running mechanical git, archive, and contract acceptance checks..."
TEST_EXIT="$TEST_EXIT" SECURITY_EXIT="$SECURITY_EXIT" python tools/verify_phase1b0.py
FINAL_EXIT=$?
