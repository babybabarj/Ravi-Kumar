...
Current mode: **research infrastructure**. BTC/ETH reliability acceptance is verified. XAUUSDT has a distinct instrument identity and a captured public exchange-rule snapshot. Its [native data audit](docs/XAU_NATIVE_DATA.md) found complete bar coverage through 2026-09-22 after official daily repairs, while historical rule replay, historical bid/ask quality, strategy approval, shadow readiness, and paper readiness remain blocked. XAUTUSDT remains a separate, unsupported product. See [XAUUSDT_TRADFI.md](XAUUSDT_TRADFI.md).
